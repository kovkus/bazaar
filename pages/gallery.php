	    		...
	    		<div class="grid_12">
    				<div class="box">
	    				<div class="box-inner">
	    					...
	    					<h1 class="dotted">Galéria</h1>
	    					
	    					
	    					<!-- Project Feed Filter -->
							<div class="unit">
								<ul class="project-feed-filter">
								   <li><a href="#" class="current" data-filter="*">Všetky</a></li>
								   <li><a href="#" data-filter=".food">Jedlá</a></li>
								   <li><a href="#" data-filter=".restaurant">Priestory</a></li>
								</ul>
							</div>
